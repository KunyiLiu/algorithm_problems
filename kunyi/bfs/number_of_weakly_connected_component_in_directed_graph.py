...
class Graph:
    ...
    def weak_connections(self):
        ...
        return len(set(map(lambda x: self.find(subsets, x.parent), subsets)))
...
if __name__ == '__main__':
    ...
    print 'The number of weakly connections? {}'.format(g.weak_connections())
